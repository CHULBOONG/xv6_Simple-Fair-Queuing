...
int main(void)
{
  ...
  sfq_test();
  11:	e8 0a 00 00 00       	call   20 <sfq_test>
  exit();
  ...
  26:	31 db                	xor    %ebx,%ebx
{
  ...
  37:	83 c4 10             	add    $0x10,%esp
    pid = fork();
  3a:	e8 9b 03 00 00       	call   3da <fork>
    if (pid < 0)
  3f:	85 c0                	test   %eax,%eax
  41:	78 4d                	js     90 <sfq_test+0x70>
  43:	83 c3 01             	add    $0x1,%ebx
    if (pid == 0)
  46:	85 c0                	test   %eax,%eax
  48:	74 60                	je     aa <sfq_test+0x8a>
  for (n = 0; n < N; n++)
  4a:	83 fb 03             	cmp    $0x3,%ebx
  4d:	75 eb                	jne    3a <sfq_test+0x1a>
  4f:	90                   	nop
    if (wait() < 0)
  50:	e8 95 03 00 00       	call   3ea <wait>
  55:	85 c0                	test   %eax,%eax
  57:	78 3d                	js     96 <sfq_test+0x76>
  for (; n > 0; n--)
  59:	83 eb 01             	sub    $0x1,%ebx
  5c:	75 f2                	jne    50 <sfq_test+0x30>
  if (wait() != -1)
  5e:	e8 87 03 00 00       	call   3ea <wait>
  63:	83 f8 ff             	cmp    $0xffffffff,%eax
  66:	0f 85 03 01 00 00    	jne    16f <sfq_test+0x14f>
  printf(1, "simple fair queuing scheduling test OK\n");
  ...
  92:	74 ca                	je     5e <sfq_test+0x3e>
  94:	eb ba                	jmp    50 <sfq_test+0x30>
      printf(1, "wait stopped early\n");
  96:	83 ec 08             	sub    $0x8,%esp
  99:	68 37 09 00 00       	push   $0x937
  9e:	6a 01                	push   $0x1
  a0:	e8 8b 04 00 00       	call   530 <printf>
      exit();
  a5:	e8 38 03 00 00       	call   3e2 <exit>
      sfq(weight);
  aa:	83 ec 0c             	sub    $0xc,%esp
        print_counter--;
  ad:	bf ff e0 f5 05       	mov    $0x5f5e0ff,%edi
      sfq(weight);
  b2:	53                   	push   %ebx
  b3:	e8 ca 03 00 00       	call   482 <sfq>
      uint start_ticks = uptime();
  b8:	e8 bd 03 00 00       	call   47a <uptime>
  bd:	83 c4 10             	add    $0x10,%esp
  c0:	89 45 dc             	mov    %eax,-0x24(%ebp)
        counter++;
  c3:	ba 01 00 00 00       	mov    $0x1,%edx
  c8:	31 c9                	xor    %ecx,%ecx
      int first = 1;
  ca:	c7 45 e0 01 00 00 00 	movl   $0x1,-0x20(%ebp)
  d1:	eb 12                	jmp    e5 <sfq_test+0xc5>
  d3:	90                   	nop
  d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      while (counter <= MAX_COUNTER)
  d8:	89 d0                	mov    %edx,%eax
  da:	89 ce                	mov    %ecx,%esi
  dc:	35 01 65 cd 1d       	xor    $0x1dcd6501,%eax
  e1:	09 c6                	or     %eax,%esi
  e3:	74 70                	je     155 <sfq_test+0x135>
        counter++;
  e5:	83 c2 01             	add    $0x1,%edx
  e8:	83 d1 00             	adc    $0x0,%ecx
        if (print_counter == 0)
  eb:	83 ef 01             	sub    $0x1,%edi
  ee:	75 e8                	jne    d8 <sfq_test+0xb8>
          if (first)
  f0:	8b 75 e0             	mov    -0x20(%ebp),%esi
          print_counter = PRINT_TIME;
  f3:	bf 00 e1 f5 05       	mov    $0x5f5e100,%edi
          if (first)
  f8:	85 f6                	test   %esi,%esi
  fa:	74 dc                	je     d8 <sfq_test+0xb8>
  fc:	89 55 e0             	mov    %edx,-0x20(%ebp)
  ff:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
            end_ticks = uptime();
 102:	e8 73 03 00 00       	call   47a <uptime>
 107:	89 c6                	mov    %eax,%esi
            printf(1, "PID: %d (weight: %d), ", getpid(), weight);
 109:	e8 54 03 00 00       	call   462 <getpid>
 10e:	53                   	push   %ebx
 10f:	50                   	push   %eax
 110:	68 0c 09 00 00       	push   $0x90c
 115:	6a 01                	push   $0x1
 ...
 11e:	2b 45 dc             	sub    -0x24(%ebp),%eax
 121:	8b 55 e0             	mov    -0x20(%ebp),%edx
 124:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
 127:	89 55 d0             	mov    %edx,-0x30(%ebp)
 12a:	8d 04 80             	lea    (%eax,%eax,4),%eax
 12d:	89 0c 24             	mov    %ecx,(%esp)
 130:	52                   	push   %edx
 131:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
 134:	01 c0                	add    %eax,%eax
 136:	50                   	push   %eax
 137:	68 b0 08 00 00       	push   $0x8b0
 13c:	6a 01                	push   $0x1
 13e:	e8 ed 03 00 00       	call   530 <printf>
 143:	83 c4 20             	add    $0x20,%esp
            first = 0;
 146:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
 14d:	8b 55 d0             	mov    -0x30(%ebp),%edx
 150:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
 153:	eb 83                	jmp    d8 <sfq_test+0xb8>
      printf(1, "PID: %d terminated\n", getpid());
 155:	e8 08 03 00 00       	call   462 <getpid>
 15a:	83 ec 04             	sub    $0x4,%esp
 15d:	50                   	push   %eax
 15e:	68 23 09 00 00       	push   $0x923
 163:	6a 01                	push   $0x1
 165:	e8 c6 03 00 00       	call   530 <printf>
      exit();
 16a:	e8 73 02 00 00       	call   3e2 <exit>
    printf(1, "wait got too many\n");
 16f:	50                   	push   %eax
 170:	50                   	push   %eax
 171:	68 4b 09 00 00       	push   $0x94b
 176:	6a 01                	push   $0x1
 178:	e8 b3 03 00 00       	call   530 <printf>
    exit();
 17d:	e8 60 02 00 00       	call   3e2 <exit>
 ...
 499:	85 d2                	test   %edx,%edx
{
 ...
 4c7:	f7 f1                	div    %ecx
 4c9:	0f b6 92 68 09 00 00 	movzbl 0x968(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 6e4:	e9 8f fe ff ff       	jmp    578 <printf+0x48>
          s = "(null)";
 6e9:	bb 5e 09 00 00       	mov    $0x95e,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 701:	a1 3c 0c 00 00       	mov    0xc3c,%eax
{
 ...
 73d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 73f:	a3 3c 0c 00 00       	mov    %eax,0xc3c
}
 744:	5b                   	pop    %ebx
 745:	5e                   	pop    %esi
 746:	5f                   	pop    %edi
 ...
 756:	72 ce                	jb     726 <free+0x26>
{
 ...
 777:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 77a:	a3 3c 0c 00 00       	mov    %eax,0xc3c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 15 3c 0c 00 00    	mov    0xc3c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7df:	73 47                	jae    828 <malloc+0x98>
    ...
    if(p == freep)
 7e1:	39 05 3c 0c 00 00    	cmp    %eax,0xc3c
 ...
 806:	e8 f5 fe ff ff       	call   700 <free>
  return freep;
 80b:	8b 15 3c 0c 00 00    	mov    0xc3c,%edx
 ...
 834:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 837:	89 15 3c 0c 00 00    	mov    %edx,0xc3c
}
 ...
 849:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 3c 0c 00 00 40 	movl   $0xc40,0xc3c
 857:	0c 00 00 
 85a:	c7 05 40 0c 00 00 40 	movl   $0xc40,0xc40
 861:	0c 00 00 
    base.s.size = 0;
 864:	b8 40 0c 00 00       	mov    $0xc40,%eax
 869:	c7 05 44 0c 00 00 00 	movl   $0x0,0xc44
 870:	00 00 00 
